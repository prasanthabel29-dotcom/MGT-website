...
function ServiceDetails() {
  ...
  const services = [

    {
      ...
      image: img1,
      desc: "We develop scalable, secure and high-performance custom software.",
      points: [
...

    {
      ...
      image: img2,
      desc: "Modern Android & iOS apps with smooth UI.",
      points: [
        "Android & iOS",
...

    {
      ...
      image: img3,
      desc: "Fast, responsive, SEO-friendly websites.",
      points: [
        "Business Sites",
        "E-Commerce",
        "Landing Pages",
...

    {
      ...
      image: img4,
      desc: "Boost traffic and online visibility.",
      points: [
        "SEO",
        "Google Ads",
        "Social Media",
...

    {
      ...
      image: img5,
      desc: "Keep apps secure and optimized.",
      points: [
        "Bug Fix",
        "Optimization",
        "Security",
...

    {
      ...
      image: img7,
      desc: "Safe data transfer across systems.",
      points: [
        "DB Migration",
        "Cloud",
        "Security",
...

    {
      ...
      image: img9,
      desc: "Strong business IT systems.",
      points: [
        "Network",
        "Servers",
        "Security",
...

    {
      ...
      image: img10,
      desc: "We specialize in sourcing high-quality candidates.",
      points: [
        "Full-Time Hiring",
        "Contract Staffing",
        "RPO",
